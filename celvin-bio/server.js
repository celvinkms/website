...
function v4PublicTopLayers(c) {
  ...
  const enter = c.enter_screen_enabled ? `<div class="ux-enter" id="uxEnter"><div class="ux-enter-card"><div class="ux-enter-title">${enterText}</div></div></div>` : "";
