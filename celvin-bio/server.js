...
const DEFAULT_CONFIG = {
  ...
  enter_screen_enabled: false, enter_screen_text: "click here :3", share_bar_enabled: true, copy_button_enabled: true, theme_toggle_enabled: false,
...
.ux-enter{position:fixed;inset:0;z-index:9998;display:flex;align-items:center;justify-content:center;background:radial-gradient(circle at 50% 38%,color-mix(in srgb,var(--a) 10%,transparent),rgba(0,0,0,.18) 24%,rgba(0,0,0,.56) 100%);backdrop-filter:blur(12px) saturate(120%);cursor:pointer;transition:.38s}.ux-enter.hidden{opacity:0;pointer-events:none}.ux-enter-card{min-width:min(92vw,340px);display:flex;flex-direction:column;align-items:center;gap:8px;padding:18px 18px 16px;border-radius:28px;border:1px solid color-mix(in srgb,var(--a) 28%,rgba(255,255,255,.14));background:linear-gradient(180deg,rgba(255,255,255,.12),rgba(255,255,255,.04));box-shadow:0 25px 90px rgba(0,0,0,.34),0 0 40px color-mix(in srgb,var(--a) 10%,transparent);backdrop-filter:blur(20px)}.ux-enter-kicker{font-family:'Space Mono',monospace;font-size:10px;letter-spacing:.22em;text-transform:uppercase;color:color-mix(in srgb,var(--t) 48%,transparent)}.ux-enter-title{font-size:clamp(22px,4vw,30px);font-weight:800;letter-spacing:-.04em;color:#fff;text-shadow:0 0 22px color-mix(in srgb,var(--a) 22%,transparent)}.ux-enter-title em{font-style:normal;color:var(--a)}.ux-enter-sub{font-family:'Space Mono',monospace;font-size:11px;color:color-mix(in srgb,var(--t) 58%,transparent)}.ux-enter-pill{margin-top:2px;display:inline-flex;align-items:center;gap:8px;padding:10px 14px;border-radius:999px;border:1px solid color-mix(in srgb,var(--a) 34%,transparent);background:color-mix(in srgb,var(--a) 10%,transparent);font-family:'Space Mono',monospace;font-size:11px;color:#fff;animation:pulse 1.8s infinite}.ux-enter-dot{width:10px;height:10px;border-radius:999px;background:var(--a);box-shadow:0 0 18px var(--a)}.ux-watermark{position:fixed;left:14px;bottom:12px;font-family:'Space Mono',monospace;font-size:10px;color:color-mix(in srgb,var(--t) 20%,transparent);z-index:60}.ux-analytics-pill{position:fixed;left:14px;top:14px;font-family:'Space Mono',monospace;font-size:10px;color:var(--a);border:1px solid color-mix(in srgb,var(--a) 30%,transparent);border-radius:999px;padding:6px 10px;background:rgba(0,0,0,.45);z-index:60}
...
function v4PublicTopLayers(c) {
  ...
  const enterText = esc(c.enter_screen_text || "click here :3");
  const enter = c.enter_screen_enabled ? `<div class="ux-enter" id="uxEnter"><div class="ux-enter-card"><div class="ux-enter-kicker">ambient mode</div><div class="ux-enter-title">${enterText}</div><div class="ux-enter-sub">tap anywhere to enter</div><div class="ux-enter-pill"><i class="ux-enter-dot"></i><span>click here <em>:3</em></span></div></div></div>` : "";
...
function renderBioPage(c) {
  ...
  const audioWidget = c.audio_url ? `
    ${c.audio_autoplay ? `
    <div id="click-to-enter" class="audio-enter">
      <div class="audio-enter-card">
        <div class="audio-enter-kicker">ambient audio</div>
        <div class="audio-enter-title">click here <span>:3</span></div>
        <div class="audio-enter-sub">tap to start the music</div>
        <div class="audio-enter-pill"><i></i><span>ready when you are</span></div>
      </div>
    </div>` : ""}
    ...
    <style>
    .audio-enter{position:fixed;inset:0;z-index:9999;display:flex;align-items:center;justify-content:center;background:radial-gradient(circle at 50% 36%,color-mix(in srgb,var(--a) 11%,transparent),rgba(0,0,0,.16) 24%,rgba(0,0,0,.58) 100%);backdrop-filter:blur(12px) saturate(120%);cursor:pointer;transition:opacity .4s ease;}
    .audio-enter-card{min-width:min(92vw,340px);display:flex;flex-direction:column;align-items:center;gap:8px;padding:18px 18px 16px;border-radius:28px;border:1px solid color-mix(in srgb,var(--a) 28%,rgba(255,255,255,.14));background:linear-gradient(180deg,rgba(255,255,255,.12),rgba(255,255,255,.04));box-shadow:0 25px 90px rgba(0,0,0,.34),0 0 40px color-mix(in srgb,var(--a) 10%,transparent);backdrop-filter:blur(20px)}
    .audio-enter-kicker{font-family:'Space Mono',monospace;font-size:10px;letter-spacing:.22em;text-transform:uppercase;color:color-mix(in srgb,var(--t) 48%,transparent)}
    .audio-enter-title{font-size:clamp(22px,4vw,30px);font-weight:800;letter-spacing:-.04em;color:#fff;text-shadow:0 0 22px color-mix(in srgb,var(--a) 22%,transparent)}
    .audio-enter-title span{color:var(--a)}
    .audio-enter-sub{font-family:'Space Mono',monospace;font-size:11px;color:color-mix(in srgb,var(--t) 58%,transparent)}
    .audio-enter-pill{margin-top:2px;display:inline-flex;align-items:center;gap:8px;padding:10px 14px;border-radius:999px;border:1px solid color-mix(in srgb,var(--a) 34%,transparent);background:color-mix(in srgb,var(--a) 10%,transparent);font-family:'Space Mono',monospace;font-size:11px;color:#fff;animation:pulse 1.8s infinite}
    .audio-enter-pill i{width:10px;height:10px;border-radius:999px;background:var(--a);box-shadow:0 0 18px var(--a);display:block}
    @keyframes pulse{0%,100%{opacity:1;transform:translateY(0)}50%{opacity:.72;transform:translateY(-2px)}}
...
const V4_CONFIG=${safeJson({
  ...
  enter_screen_text: c.enter_screen_text||"click here :3",
...
function buildStudioHtml(){
  ...
  field('announcement_enabled','Announcement Bar','checkbox')+field('announcement_text','Announcement Text','text','new drop / update / status')+field('announcement_url','Announcement Link','url','https://...')+field('enter_screen_enabled','Click-to-enter Screen','checkbox')+field('enter_screen_text','Enter Text','text','click here :3')+
